...
The nearby source documentation describes it as: **zConfiguration class structure**
...
The linked source file at line `12` is authoritative. Regenerate this file after any declaration, source-path, public-member, or source-relationship change; the provenance above must match the branch being reviewed.
