...
| Declaration | `class Video` with `NotifiableObject` |
...
The linked source file at line `248` is authoritative. Regenerate this file after any declaration, source-path, public-member, or source-relationship change; the provenance above must match the branch being reviewed.
